...
@interface UIViewController (DKSideMenu)

@property (nonatomic, readonly) DKSideMenuViewController *sideMenu;

@property (nonatomic, readonly) DKContentContainerView *contentContainer;
