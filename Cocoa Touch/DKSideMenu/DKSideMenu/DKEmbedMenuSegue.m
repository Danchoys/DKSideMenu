...
#import "DKEmbedMenuSegue.h"
#import "UIViewController+DKSideMenu.h"

@implementation DKEmbedMenuSegue

- (void)perform
{
    DKSideMenuViewController *sideMenuController = [self.sourceViewController sideMenu];
    if (!sideMenuController)
        NSLog(@"DKEmbedMenuSegue can only be used with DKSideMenuController");
    [sideMenuController embedMenuViewController:self.destinationViewController];
}
